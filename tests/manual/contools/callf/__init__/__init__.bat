...
if /i "%CONTOOLS_UTILS_TESTS_ROOT_INIT0_DIR%" == "%~dp0" exit /b 0
...
call "%%CONTOOLS_ROOT%%/std/canonical_path_if_ndef.bat" PRINTARGS_EXE_PATH                  "%%CONTOOLS_UTILS_BIN_ROOT%%/contools/%%PRINTARGS_EXECUTABLE%%"

call "%%CONTOOLS_ROOT%%/std/canonical_path_if_ndef.bat" CALLF_EXE_PATH                      "%%CONTOOLS_UTILS_BIN_ROOT%%/contools/%%CALLF_EXECUTABLE%%"
call "%%CONTOOLS_ROOT%%/std/canonical_path_if_ndef.bat" CALLFG_EXE_PATH                     "%%CONTOOLS_UTILS_BIN_ROOT%%/contools/%%CALLFG_EXECUTABLE%%"

call "%%CONTOOLS_BUILD_TOOLS_ROOT%%/mkdir_if_notexist.bat" "%%TEST_DATA_OUT_DIR%%" || exit /b

set "CONTOOLS_UTILS_TESTS_ROOT_INIT0_DIR=%~dp0"
